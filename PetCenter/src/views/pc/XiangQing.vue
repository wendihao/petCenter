       ...
       <div style="background-color: white;padding: 10px;">
        <div style="display: flex;justify-content: space-around;">
          ...
          <div class="blog-message">
            ...
            <div>
              <p style="font-size: 20px" v-if="blog.varieties===1"><i class="el-icon-position blog-icon" ></i>品种: 猫 ({{blog.petsex===1?'公':'母'}})</p>
              <p style="font-size: 20px" v-if="blog.varieties===0"><i class="el-icon-position blog-icon" ></i>品种: 狗 ({{blog.petsex===1?'公':'母'}})</p>
              <p style="font-size: 20px" v-if="blog.varieties===2"><i class="el-icon-position blog-icon" ></i>品种: 其他 ({{blog.petsex===1?'公':'母'}})</p>
            </div>
            <div>
              <p style="font-size: 20px"><i class="el-icon-c-scale-to-original blog-icon"></i>年龄: {{blog.petage}}</p>
            </div>
            <div>
              <p style="font-size: 20px"><i class="el-icon-user blog-icon"></i>联系人： {{blog_user.name}}</p>
            </div>
            <div>
        ...
        <div>
          <el-button type="success" v-show="this.$route.query.status == 0&&this.$route.query.userId!=this.$route.query.adopterId&&flag" @click="dialogFormVisibles()" round>领养</el-button>
