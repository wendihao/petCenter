    ...
    <div style="width: 1120px;padding: 10px;">
      ...
      <div style="background-color: white;padding: 10px;display:flex;justify-content: space-between;">
        ...
        <div>
          ...
          <el-tag type="danger" v-if="this.$route.query.status == 1" style="font-size: initial;">已找回</el-tag>
        </div>
      </div>
      <!--领养内容-->
      <div style="background-color: white;padding: 10px;">
        <div style="display: flex;justify-content: space-around;">
          ...
          <div class="homelesspet-message">
            ...
            <div>
              <p style="font-size: 20px"><i class="el-icon-time blog-icon"></i>找回时间: {{renling.datetime}}</p>
            </div>
            <div>
              <p style="font-size: 20px"><i class="el-icon-location-outline blog-icon"></i>地点: {{homelesspet.address}}</p>
            </div>
            <div>
              <p style="font-size: 20px"><i class="el-icon-user blog-icon"></i>联系人： {{homelesspet_user.name}}</p>
            </div>
            <div>
