    ...
    <div style="width: 400px;margin-left: 35%;">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
        <el-form-item label="头像">
          <el-image style="width: 100px; height: 100px;border-radius: 50%" :src="require('../../assets/img/admin.jpg')"  ></el-image>
        </el-form-item>
  ...
  methods: {
    submitForm (formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$axios.post('http://localhost:8081/admin/insert', _this.ruleForm).then(function (resp) {
