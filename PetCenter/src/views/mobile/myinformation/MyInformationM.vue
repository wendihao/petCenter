<template>
  <div>
    <div style="background-color: white;padding: 0.1rem;width: 100%">
      ...
      <h1 style="margin-left: 40%;margin-top: -5%;font-size: 15px;font-weight: bolder">我的主页</h1>
      <hr style="margin-bottom: -1%;width: 100%">
    </div>
    <div style="width: 100%">
      <div style="width: 100%;height: 0.8rem">
      </div>
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="2rem">
        <el-form-item label="头像" prop="portrait">
          <el-upload
            ...
            :limit="1"
            ref="businessLicense">
            <el-image style="width: 2rem; height: 2rem;border-radius: 50%" :src="ruleForm.portrait" ></el-image>
          </el-upload>
        </el-form-item>
        <el-form-item label="用户名" prop="name">
          <el-input v-model="ruleForm.name" style="margin-left: 5%;width: 6rem"></el-input>
        </el-form-item>
        <el-form-item label="性别" prop="sex">
          <el-radio-group v-model="ruleForm.sex"  style="margin-left: 5%">
            <el-radio :label="1">男</el-radio>
            <el-radio :label="0">女</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item label="电话" prop="phoneid">
          <el-input v-model="ruleForm.phoneid"  style="margin-left: 5%;width: 6rem"></el-input>
        </el-form-item>
        <el-form-item label="邮箱" prop="email" >
          <el-input v-model="ruleForm.email"  style="margin-left: 5%;width: 6rem"></el-input>
        </el-form-item>
        <el-form-item label="账户" prop="username">
          <el-input v-model="ruleForm.username"  style="margin-left: 5%;width: 6rem"></el-input>
        </el-form-item>
        <el-form-item label="密码" prop="password">
          <el-input v-model="ruleForm.password"  style="margin-left: 5%;width: 6rem"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="submitForm('ruleForm')" style="margin-left: 25%">立即修改</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
