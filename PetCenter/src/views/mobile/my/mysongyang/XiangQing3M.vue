        ...
        <div style="display: flex;justify-content: space-around;">
          <div style="width: 55%;height: 100%">
            <el-carousel style="height: 100%">
              <el-carousel-item v-for="(image,index) in blog.images" :key="index" style=" height: 100%">
          ...
          <div class="blog-message">
            ...
            <div>
              <p style="font-size: 14px"><i class="el-icon-time blog-icon"></i>收养时间: {{adoption.datetime}}</p>
            </div>
            <div>
              <p style="font-size: 14px"><i class="el-icon-location-outline blog-icon"></i>地点: {{blog.address}}</p>
            </div>
            <div>
              <p style="font-size: 14px"><i class="el-icon-user blog-icon"></i>领养人： {{blog_user.name}}</p>
            </div>
            <div>
              <p style="font-size: 10px"><i class="el-icon-phone blog-icon"></i>联系电话: {{blog_user.phoneid}}</p>
            </div>
            <div style="font-size: 14px" v-if="this.$route.query.schedule==0">
              <p>审核中....</p>
            </div>
          </div>
        </div>
        <div v-if="this.$route.query.schedule==1&&this.$route.query.adopterId!=null" style="margin-top: 1rem">
