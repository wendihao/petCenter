      ...
      <div style="background-color: white;padding: 10px;">
        <div style="display: flex;justify-content: space-around;">
          ...
          <div class="blog-message">
            ...
            <div>
              <p><i class="el-icon-user blog-icon"></i>领养人： {{blog_user.name}}</p>
            </div>
            <div>
...
export default {
  ...
  created () {
    ...
    this.$axios.get('http://localhost:8081/user/selectbyid/' + _this.$route.query.adopterId).then(function (resp) {
