<template>
  <div style="height:500px;">
    <el-table :data="tableData" border style="width: 100%">
      <el-table-column fixed prop="userId" label="用户ID" width="100">
      </el-table-column>
      ...
      <el-table-column label="操作" width="150">
        <template slot-scope="scope">
          <el-button @click="getUpload(scope.row) " type="text" size="small">查看</el-button>
          ...
          <el-button @click="update(scope.row)" type="text" size="small">通过</el-button>
...
export default {
  ...
  methods: {
    ...
    getData (currentPage, userid) {
      const _this = this
      this.$axios.get('http://localhost:8081/findAll1/' + currentPage + '/5').then(function (resp) {
        console.log(resp)
