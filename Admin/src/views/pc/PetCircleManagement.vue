<template>
  <div style="height:500px;">
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="title" label="宠物圈标题" width="200">
      </el-table-column>
      ...
      <el-table-column prop="introduce" label="上传内容" width="400">
      </el-table-column>
        ...
        <template slot-scope="scope">
          ...
          <el-dialog title="详细信息" :visible.sync="dialogFormVisible" :append-to-body="true">
            <el-form :model="form" ref="form">
              ...
              <el-form-item label="宠物圈标题" :label-width="formLabelWidth">
                <el-input v-model="form.title" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="上传图片" :label-width="formLabelWidth">
                <img :src="form.images" style="height: 100px;width: 100px" />
              </el-form-item>
              ...
              <el-form-item label="浏览量" :label-width="formLabelWidth">
                <el-input v-model="form.pageview" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="评论量" :label-width="formLabelWidth">
                <el-input v-model="form.comment" autocomplete="off"></el-input>
              </el-form-item>
              <el-form-item label="上传内容" :label-width="formLabelWidth">
                <el-input
                  type="textarea"
          ...
          <el-button style="background-color: red ;color: white;width: 50px;margin-left: 10px" @click="deletePetCircle(scope.row)" type="text" size="small">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div>
...
export default {
  ...
  methods: {
    ...
    getData (currentPage) {
      const _this = this
      this.$axios.get('http://119.29.250.12:8081/findAllPetBlog/' + currentPage + '/4').then(function (resp) {
        console.log(resp)
    ...
    deletePetCircle (row) {
      const _this = this
      this.$axios.get('http://119.29.250.12:8081/deletePetCircle/' + row.id).then(function (resp) {
