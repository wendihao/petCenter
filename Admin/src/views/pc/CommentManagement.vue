<template>
  <div style="height:500px;">
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="comment" label="评论内容" width="1000">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getData (currentPage) {
      const _this = this
      this.$axios.get('http://119.29.250.12:8081/findAllComment/' + currentPage + '/4').then(function (resp) {
        console.log(resp)
    ...
    deleteComment (row) {
      const _this = this
      this.$axios.get('http://119.29.250.12:8081/deleteComment/' + row.id).then(function (resp) {
